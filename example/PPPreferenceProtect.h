...
- (void)setCancelButtonHidden:(BOOL)cancelBnHidden forPaneWithName:(NSString *)name;
...
// May want to use if auto accept is turned on
- (void)setForgotCancelButtonHidden:(BOOL)cancelBnHidden forPaneWithName:(NSString *)name;
...
- (void)setForgotShouldLog:(BOOL)shouldLog forPaneWithName:(NSString *)name;
...
- (void)setForgotCorrectEvent:(BOOL)enterPane andNotify:(NSString *)notificationId forPaneWithName:(NSString *)name;
